        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-400">
              We’re a personalised movie platform where users can explore, rate, and review films. With community-powered recommendations, watchlists, and insightful stats, CMBD helps film lovers discover what to watch—based on real user preferences and shared feedback.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter to get the latest updates on movies and more.
            </p>
            <form
              className="flex"
              onSubmit={(e) => {
