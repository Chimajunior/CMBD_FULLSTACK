    ...
    <footer className="w-full bg-gray-900 text-white py-8 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Us */}
          <div className="mb-6 md:mb-0 max-w-md text-sm leading-relaxed">
            <h3 className="text-xl font-bold mb-4">About Us</h3>
            <p className="text-gray-400">
              Discover and rate movies you love. CMBD helps you explore, review,
          ...
          <div className="mb-6 md:mb-0">
            ...
            <div className="flex space-x-4">
              ...
              >
                ...
                >
                  <path
                    d="M24 4.557a9.83 9.83 0 01-2.828.775 4.932 
                    4.932 0 002.165-2.724 9.864 9.864 0 01-3.127 
                    1.195 4.916 4.916 0 00-3.594-1.555c-3.179 0-5.515 
                    2.966-4.797 6.045A13.978 13.978 0 011.671 
                    3.149a4.93 4.93 0 001.523 6.574 4.903 
                    4.903 0 01-2.229-.616c-.054 2.281 1.581 
                    4.415 3.949 4.89a4.935 4.935 0 01-2.224.084 
                    4.928 4.928 0 004.6 3.419A9.9 9.9 0 
                    010 19.54a13.94 13.94 0 007.548 2.212c9.142 
                    0 14.307-7.721 13.995-14.646A10.025 
              ...
              >
                ...
                >
                  <path
                    ...
                    .593 0 1.325v21.351C0 23.407.593 24 
                    ...
                    1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.733 
                    0 1.325-.592 1.325-1.325V1.325C24 
              ...
              >
                ...
                >
                  <path
                    ...
                    1.645-.069 4.849-.069zm0-2.163c-3.259 
                    0-3.667.014-4.947.072-4.358.2-6.78 
                    2.618-6.98 6.98-.059 1.281-.073 1.689-.073 
                    4.948 0 3.259.014 3.668.072 4.948.2 
                    4.358 2.618 6.78 6.98 6.98 1.281.058 
                    1.689.072 4.948.072 3.259 0 3.668-.014 
                    ...
                    6.162s2.759 6.163 6.162 6.163 
                    6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 
                    10.162c-2.209 0-4-1.79-4-4 0-2.209 
                    1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 
                    4-4 4z"
                  />
                </svg>
              </a>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          &copy; {new Date().getFullYear()} CMBD. All rights reserved.
        </div>
      </div>
    </footer>
  );
...
//             <h3 className="text-xl font-bold mb-4">About Us</h3>
//             <p className="text-gray-400">
//               We are a movie enthusiast platform dedicated to bringing you the
//               latest and greatest. Explore, discover, and enjoy recommendations!
//             </p>
//           </div>
