...
export default function SettingsForm({
  ...
  const checkAvailability = async (type, value, setter) => {
    try {
      const res = await fetch(`/api/auth/check?${type}=${value}`);
  ...
  return (
    <div className="space-y-6 max-w-xl text-white">
      ...
      <textarea
        ...
        placeholder="Tell us about yourself (optional bio)"
        className="w-full bg-[#1a1a1a] text-white px-4 py-2 rounded h-24 resize-none"
      />
